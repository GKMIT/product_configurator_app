...
module.exports = function () {
    ...
    app.post('/users/mark_onhold/:rfq_id/:rfq_status_id', globalfunctions.checkSalesAuth, quote_finalize.mark_onhold);
	...
	app.get('/users/onhold_followup', globalfunctions.checkSalesAuth, quote_finalize.onhold_followup);
